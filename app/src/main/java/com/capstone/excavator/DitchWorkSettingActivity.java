...
public class DitchWorkSettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setFullScreenMode();
        setContentView(R.layout.activity_ditch_work_setting);
        ...
        if (btnPrev != null) {
            btnPrev.setOnClickListener(v -> {
                startActivity(new Intent(this, LevelSettingActivity.class));
                finish();
            });
        }
        ...
        if (btnNext != null) {
            btnNext.setOnClickListener(v -> {
                Toast.makeText(this, "下一步页面待创建", Toast.LENGTH_SHORT).show();
            });
        }
    }
