...
public class SlopeRepairSecondSettingActivityPointB extends ScaledAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setFullScreenMode();
        setContentView(R.layout.activity_slope_repair_second_setting_pointb);
